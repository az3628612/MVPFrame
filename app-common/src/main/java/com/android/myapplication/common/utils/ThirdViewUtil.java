package com.android.myapplication.common.utils;
...
import com.android.myapplication.common.base.Platform;
...
public class ThirdViewUtil {
    ...
    public static View convertAutoView(String name, Context context, AttributeSet attrs) {
        ...
        if (!Platform.DEPENDENCY_AUTO_LAYOUT) return null;
        ...
        } else if (name.equals(ActivityDelegate.LAYOUT_LINEARLAYOUT)) {
            view = new AutoLinearLayout(context, attrs);
        } else if (name.equals(ActivityDelegate.LAYOUT_RELATIVELAYOUT)) {
